                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <span v-if="user.image != null">
                                        <img src="../assets/img/profile1.png" class="rounded-circle" width="150"
                                            alt="Avatar Profile">
                                    </span>
                                    <span v-else>
                                        <img src="../assets/img/profile-default.png" class="rounded-circle" width="150"
                                            alt="Avatar Profile">
                                    </span>
                                    <div class="mt-3">
                    ...
                    <div class="col-md-8">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-success btn-edit-form" target="__blank" href="#">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h6 class="d-flex align-items-center mb-3">
                                            <i class="material-icons text-info mr-2"></i>Description</h6>
